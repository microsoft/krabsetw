...
namespace O365 { namespace Security { namespace ETW {
    ...
    public:
        ...
        {
            return gcnew Predicate(krabs::predicates::property_equals<adapt::null_string<char>>(
        ...
        {
            return gcnew Predicate(krabs::predicates::property_iequals<adapt::null_string<char>>(
                msclr::interop::marshal_as<std::wstring>(name),
                msclr::interop::marshal_as<std::string>(value)));
        }
        ...
        {
            return gcnew Predicate(krabs::predicates::property_contains<adapt::null_string<char>>(
                msclr::interop::marshal_as<std::wstring>(name),
                msclr::interop::marshal_as<std::string>(value)));
        }
        ...
        {
            return gcnew Predicate(krabs::predicates::property_icontains<adapt::null_string<char>>(
                msclr::interop::marshal_as<std::wstring>(name),
                msclr::interop::marshal_as<std::string>(value)));
        }
        ...
        {
            return gcnew Predicate(krabs::predicates::property_starts_with<adapt::null_string<char>>(
                msclr::interop::marshal_as<std::wstring>(name),
                msclr::interop::marshal_as<std::string>(value)));
        }
        ...
        {
            return gcnew Predicate(krabs::predicates::property_istarts_with<adapt::null_string<char>>(
                msclr::interop::marshal_as<std::wstring>(name),
                msclr::interop::marshal_as<std::string>(value)));
        }
    };
